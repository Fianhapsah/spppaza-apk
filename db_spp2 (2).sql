...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 10, 2023 at 07:08 AM
...
(777, 'XII-RPL 1', 'Rekayasa Perangkat Lunak'),
(999, 'XII-RPL 2', 'Rekayasa Perangkat Lunak');
...
(1, 1, '124', '2023-02-01', 'juni', '2019', 2, 870000000),
(7, 1, '122', '2023-03-03', 'Februari', '2023', 1, 5000000),
(9, 1, '123', '2023-03-03', 'Februari', '2023', 1, 5000000);
...
('122', '141', 'Sri Yulia Ningsih', 999, 'JALAN KERTAMAYA NO 76', '0858998651677', 1, 2),
('123', '142', 'Siti Fatimah rohmah', 999, 'JALAN DIPONEGORO NO.1 DARMO 3', '0858998651670', 3, 4);
...
CREATE TABLE `users` (
  ...
  `level` enum('petugas','admin','siswa') NOT NULL DEFAULT 'siswa',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(7, 'Sri Yulia Ningsih', 'siswa@gmail.com', NULL, '$2y$10$fd2xJFanjvfw7r6a0nd8ouSXxed0Ez4hF2meZWcKXAjsRW3i5bSeW', NULL, 'siswa', '2023-02-26 19:23:13', '2023-02-26 19:23:13');
